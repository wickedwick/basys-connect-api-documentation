...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Connect16ResTfulV1.UpdateTransactionInfo();
  });
  ...
  describe('UpdateTransactionInfo', function() {
    it('should create an instance of UpdateTransactionInfo', function() {
      // uncomment below and update the code to test UpdateTransactionInfo
      //var instane = new Connect16ResTfulV1.UpdateTransactionInfo();
      //expect(instance).to.be.a(Connect16ResTfulV1.UpdateTransactionInfo);
    });
