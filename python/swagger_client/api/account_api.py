...
class AccountApi(object):
    ...
    def api_v1_account_get_account_settings_get(self, account, password, **kwargs):  # noqa: E501
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v1_account_get_account_settings_get_with_http_info(account, password, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v1_account_get_account_settings_get_with_http_info(account, password, **kwargs)  # noqa: E501
            return data
